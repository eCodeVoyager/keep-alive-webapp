...
const ContactPage = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Us"
        description="Get in touch with the Server team. We're here to help 24/7 with any questions about our website monitoring service."
        keywords="contact Server, support, customer service, help desk, website monitoring support"
      />
