...
const Hero = () => {
  ...
  return (
    <>
      <SEO
        title="Keep Your Free Projects Alive 24/7"
        description="Keep your Render, Azure, and other free-tier hosted projects alive 24/7. Perfect for portfolios, demos, and side projects."
        keywords="website monitoring, free hosting, Render, Azure, uptime monitoring, portfolio hosting, project monitoring"
      />
            ...
            >
              {[
                ...
                },
                {
                  ...
                  title: "Always Active",
                  description:
                    "Automated pings keep your projects running 24/7",
