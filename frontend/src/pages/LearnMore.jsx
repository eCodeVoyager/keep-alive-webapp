...
const LearnMore = () => {
  ...
  return (
    <>
      <SEO
        title="How Server Works"
        description="Learn how Server keeps your free projects running 24/7 with smart interval pinging, uptime monitoring, and instant alerts."
        keywords="how Server works, website monitoring features, uptime monitoring, ping service, free hosting solutions"
      />
