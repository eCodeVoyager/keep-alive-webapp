  ...
  return (
    <>
      <SEO
        ...
        description="Sign in to your Server account to manage your website monitoring settings and view your project status."
        keywords="login, sign in, Server login, account access, website monitoring login"
      />
      <motion.div
