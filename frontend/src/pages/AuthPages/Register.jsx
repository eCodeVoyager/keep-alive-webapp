...
const KeepAliveRegisterForm = () => {
  ...
  return (
    <>
      <SEO
        title="Create Your Server Account"
        description="Sign up for Server to start monitoring your free projects and keep them running 24/7. Free tier available with essential features."
        keywords="sign up, register, create account, Server registration, website monitoring account"
      />
      <motion.div
